...
public class AdapterPages extends RecyclerView.Adapter<AdapterPages.ViewHolder> {
    ...
    public AdapterPages (Context context, ArrayList<Product> productList, ArrayList<String> favoriteList){
    ...
    @NonNull
    @Override
    public AdapterPages.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_grid_layout, parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterPages.ViewHolder holder, int position) {
